...
export default function ResourcesPage() {
  ...
  // ✅ Dummy data
  const resources = [
    { id: 1, title: "Math Notes", author: "Dr. Smith", type: "pdf", subject: "Math", thumbnail: "https://imgv2-1-f.scribdassets.com/img/document/384088861/original/b5633f3ee1/1667609834?v=1", url: "https://www.africau.edu/images/default/sample.pdf" },
    { id: 2, title: "Physics Lecture", author: "Prof. Johnson", type: "video", subject: "Physics", url: "https://www.w3schools.com/html/mov_bbb.mp4" },
    { id: 3, title: "Chemistry Guide", author: "Dr. Brown", type: "pdf", subject: "Chemistry", thumbnail: "https://www.bing.com/th/id/OIP.WpNTI71d4f-oqWj6pY1ElQHaJ4?w=160&h=211&c=8&rs=1&qlt=70&o=7&cb=thws5&dpr=1.5&pid=3.1&rm=3", url: "https://www.adobe.com/support/products/enterprise/acs/pdfs/acs_ecomm_wp.pdf" },
    { id: 4, title: "Biology Seminar", author: "Dr. Clark", type: "video", subject: "Biology", url: "https://www.w3schools.com/html/movie.mp4" },
    { id: 5, title: "Algebra Cheat Sheet", author: "Tutor Sam", type: "pdf", subject: "Math", thumbnail: "https://www.edn.com/eeweb-content/wp-content/uploads/algebra.png", url: "https://arxiv.org/pdf/quant-ph/0410100.pdf" },
  ];
