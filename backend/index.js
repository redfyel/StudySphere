...
const startServer = async () => {
    try {
        ...
        // --- MIDDLEWARE SETUP ---
        app.use(cors({
            origin: ['http://localhost:3000', 'http://localhost:5173', 'https://studysphere-n4up.onrender.com', 'https://the-study-sphere.vercel.app',"https://study-sphere-git-final-redfyels-projects.vercel.app",'https://studysphere-n4up.onrender.com'],
            credentials: true
        }));
